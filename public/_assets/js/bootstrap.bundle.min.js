      ...
      : Te(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              'rtl' === Jt(s || i).direction && (a += Kt(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
            );
          })(te(t))
        );
  }
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [m].concat(b).reduce(function (t, i) {
              return t.concat(
                Vt(i) === vt
                  ? ke(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: g })
                  : i
              );
            }, []),
            y = e.rects.reference,
