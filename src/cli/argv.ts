...
export default (pkg) => {
  ...
  .options({
    ...
    db:           { alias: '',   description: 'Path to database file',                 type: "string",  default: './db.json'                                },
    middlewares:  { alias: 'md', description: 'Path to middlewares file',              type: "string",  default: "./middlewares.js"                         },
    injectors:    { alias: 'in', description: "Path to Injectors file",                type: "string",  default: "./injectors.json"                         },
    store:        { alias: 'st', description: 'Path to Store file',                    type: "string",  default: "./store.json"                             },
    rewriters:    { alias: 'rw', description: 'Path to Rewriter file',                 type: "string",  default: "./rewriters.json"                         },
